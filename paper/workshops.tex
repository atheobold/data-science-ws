...
\if1\blind
{
  ...
  \textit{National Network of Library of Medicine}- Pacific Northwest Region for
  supporting this research.} \hspace{.2cm}\\
...
the larger academic community. As such, they promote continued learning of 
...
data science skills, such as Data Carpentry. While
...
statistical preparation environmental science students experience during their
degrees. These statistics courses, however, often do not expose students to data
science skills that may be necessary for them to carry out an analysis they
...
students by their curriculum. In the first, a large-scale study of ecology
...
\quad The fundamental question raised ten years ago by Nolan and Temple Lang
still applies today: do our students leave the statistics classroom able to
``compute confidently, reliably, and efficiently?'' (\citeyear{nolan}, p.\ 100).
An in-depth study of environmental 
...
Carpentry and Software Carpentry lessons to this population. Section 
...
Carpentry and Software Carpentry curriculum. Adhering to the recommendations of 
...
departments was sent an email requesting their participation in this research. 
...
skills. The interview protocol, data, and analysis files associated with this
manuscript are available through Dryad \citep{dryad_data}. 
...
During the first stage, every faculty member's interview was transcribed
...
other data wrangling operations, such as filtering out rows or selecting columns. 
...
\noindent While some faculty had difficulty disentangling the statistical
...
\noindent Every faculty member emphasized the necessity for students' analyses
...
research are available through GitHub\footnote{The GitHub repository can be
accessed here: \url{https://github.com/atheobold/data-science-ws}}, with video
tutorials recorded and available through our institution's library\footnote{
...
discussion of the computing concept(s). This group dialogue created an inclusive
...
(\texttt{R}), environments that facilitate the learning of \texttt{R}
...
last 20 years, and the use of \R~for scientific research has multiplied, there
...
created user friendly \texttt{R} tools that ``share an underlying design
...
ggplot2 (\citeyear{ggplot}). The common syntax of these packages lessens
learner's cognitive load, allowing for a participant to leave each workshop with
...
through exercises that repeat operations on a dataset using both a 
...
that copies and pastes the same process multiple times, attendees see
...
attendees and their reported occupations. 
...
departments and occupations in the pre-workshop survey.}
...
To date, we have held 14 workshops, serving 382 members of the Montana State     
...
Master and Doctoral programs in Statistics, but because of the widespread use
...
creation of data visualizations, and use of reproducible work flows. 
...
acquire data science knowledge and skills that ``they have not had the
...
\noindent We give special thanks to the participants of this study,
without whom this research would not have been possible. We also thank the 
workshop instructors and helpers for helping to grow the data
